...
# --- 特定條件直接進入審核 ---
# 針對一廠或二廠的廠長室人員(master=1)，職級副組長/副課長以下(nlevel<=650)，且屬於「副主任2督導」(second=2)者，只要不是工會會務假(67)，皆需審核
...
# --- 特殊情況進入審核 ---
# 理監事會務假(67)：若職級為組長/課長(700)，或職級為副組長/副課長(650)且身分標記為「只有副組長(onlySecond=1)」，則需審核
