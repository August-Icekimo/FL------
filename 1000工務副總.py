...
# 彬鴻修改: 製證及品檢封裝股流程-空白 (secondDept==4)，請假時數大於8小時且為公假(非本廠公務) (31)，需經過工務副總
if secondDept==4 and (hours>8 and vaid==31):   #彬鴻修改
    return True

# 彬鴻修改: 製證及品檢封裝股流程-品檢封裝製證 (secondDept==5)，請假時數大於8小時且為公假(非本廠公務) (31)，需經過工務副總
