...
# 若部門為第一工廠(1)或第二工廠(2)，則跳過此關 (註: 一、二廠可能有其專屬流程)
if plevel==1 or plevel==2: 
    return False

# 職級在「單位主管」(800)(含)以上者，不經過人事主任
if nlevel>=800: 
   return False
...
# 若為公出(4)、公假(本廠公務)(7) 或 各式補休(35, 36, 37, 38, 109, 110, 111)，跳過人事主任簽核
