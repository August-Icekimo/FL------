...
# 若假別為特定紀念日或會務假，必須經過人事組長簽核
# 117: 開國紀念日隔天, 118: 革命先烈紀念日, 119: 孔子誕辰紀念日, 120: 臺灣光復節, 67: 理監事會務假
if vaid==117 or vaid==118 or vaid==119 or vaid==120 or vaid==67:
    return True

# 若假別為公假(本廠公務)(7)、理監事會務假(67)、公差(5)、遞延休假(21)，則跳過此關
...
# 1. 事假(12)、休假(20)、遞延休假(21)、特准病假(15) 且 時數 <= 8 小時
# 2. 公出(4)、公假(本廠公務)(7)、各式補休(35, 36, 37, 38, 109, 110, 111)
# 若符合上述任一條件，跳過人事組長簽核
...
# 針對職級在「副單位主管」(750)(含)以下，且非一廠(1)、二廠(2)之人員：
# 若為公出(4)、公假(本廠公務)(7) 或 各式補休(35, 36, 37, 38, 109, 110, 111)，跳過人事組長簽核
...
# 針對職級在「副單位主管」(750)(含)以下，且非一廠(1)、二廠(2)之人員：
# 若假別「非」上述常見免簽假別（公出/公假/補休/休假20/遞延休假21/事假12/病假14），
# 「或者」請假時數 > 8 小時，
