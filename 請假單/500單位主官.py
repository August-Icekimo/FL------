...
# 製證及品檢封裝股流程-空白 (secondDept=4) 或 品檢封裝製證 (secondDept=5) 且 符合特定假別或時數條件者，需審核
# 條件為：請假時數>8、連續天數>1、或 特定假別(婚假13,喪假16,家庭照顧18,流產26,娩假27,產檢28,非本廠公假31,生理假93)
if secondDept in (4, 5) and (hours>8 or continueDays>1 or vaid in (13, 16, 18, 26, 27, 28, 31, 93)):   #彬鴻修改
    return True
...
if master==2 and plevel not in (1, 2) and nlevel<800:
    return True
